...
namespace AutoCADCommands
{
    ...
    public static class Draw
    {
        ...
        public static ObjectId AddToModelSpace(this Entity ent)
        {
            ...
            using (Transaction trans = db.TransactionManager.StartTransaction())
            {
                //TODO:将调用静态方法GetBlockModelSpaceId()改为调用拓展方法GetBlockModelSpaceId()
                ...
                id = ((BlockTableRecord)trans.GetObject(new SymbolUtilityServices().GetBlockModelSpaceId(db), OpenMode.ForWrite, false)).AppendEntity(ent);
